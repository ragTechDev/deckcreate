...
interface ConceptExplainerShortProps {
  brand: Brand;
  keyPhrase: string;
  description: string;
...
export const ConceptExplainerShort: React.FC<ConceptExplainerShortProps> = ({
  brand,
  keyPhrase,
  description,
  durationInFrames,
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', whiteSpace: 'pre', marginBottom: 24 }}>
            ...
            <div style={{ opacity: descOpacity }}>
              <div style={{ fontSize: 21, color: '#484f58', marginBottom: 15, letterSpacing: '0.03em' }}>
                {'> output:'}
              </div>
              <div
                style={{
