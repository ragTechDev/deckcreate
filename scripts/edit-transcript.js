...
function buildInstructionsBlock() {
  return [
    ...
    '                  Add title= to show a title phrase at the start of the hook (shorts only):',
    '                    > HOOK "exciting moment" title="AI is eating the world"',
    '                  Add placement= to choose where the title appears (default: upper):',
    '                    > HOOK "exciting moment" title="AI is eating the world" placement="upper"',
    '                    > HOOK "exciting moment" title="AI is eating the world" placement="middle"',
    '                  upper = top 20% of frame; middle = just above the captions.',
    ...
    '                    > FullscreenMedia  at="word"  duration=6  src="assets/b-roll.mp4"  mediaType="video"',
    '                  FullscreenMedia scales an image, video, or GIF to fit the full width of the camera frame',
    '                  (1920 px longform / 1080 px shortform) while preserving aspect ratio. The media is',
    '                  centred vertically; letterbox bars appear above/below if shorter than the frame height.',
    '                  No enter/exit transitions — appears and disappears on the exact frame boundary.',
    '                  Works in both hook and main video sections.',
    '                  Sits above the camera video but below captions.',
    '                  src= required — path relative to /public (e.g. "assets/clip.mp4") or direct URL.',
    '                  mediaType= required — "image" | "video" | "gif".',
    '                  muted= optional — "true" to silence overlay video (default false).',
    '',
